    ...
    <Sidebar variant="inset" collapsible="icon" {...props}>
      ...
      <SidebarContent>
                    ...
                    <SidebarMenuItem>
                      <CollapsibleTrigger asChild>
                        <SidebarMenuButton
                          ...
                          aria-label={`${item.title}${isActive ? " (expanded)" : " (collapsed)"}`}
                        >
                          {item.icon && (
                      ...
                      <CollapsibleContent>
                        <SidebarMenuSub role="group" aria-label={`${item.title} submenu`}>
        ...
        {filteredAdmin.length > 0 && (
          <SidebarGroup>
            <SidebarGroupLabel aria-label="Administration navigation">
              Administration
            </SidebarGroupLabel>
            <SidebarMenu>
